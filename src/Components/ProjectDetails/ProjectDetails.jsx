    ...
    <div className="projectData">
      ...
      <footer>
        <div className="content">
          ...
          <div className="icons">
                <a href="https://www.instagram.com/brains_international?igsh=eHZveHZ5dnNlaTNu&utm_source=qr" target='_blank' rel='noreferrer'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-instagram" viewBox="0 0 16 16">
                  ...
                  <a href="https://wa.me/255654840518?text=Hi, BrainsInc Here! How are you?" target='_blank' rel='noreferrer'>
          ...
          <a href="mailto:damiandeo89@gmail.com" className='btn'>Get in touch</a>
        </div>
        <p className='copy'>&#169; copyrights {date}. Made by <a href="https://github.com/Clavius4" target='_blank' rel='noreferrer'>Paul Nkingwa Thomas</a></p>
      </footer>
    </div>
  )
}
